<div class="row" id="upload_web">
    <div class="col-md-12">
        <div class="card mt-20">
            <div class="card-content">
                <h3 class="card-title"> <i class="fa fa-user-circle" aria-hidden="true"></i> UPLOAD WEB</h3>
                <div class="toolbar"></div>
                <div clas="col col-md-3"></div>
                <div clas="col col-md-6">
                    <input type="file" id="file" name="file_upload_web">
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#upload_web").on('click', '#upload', function() {
            var file = $("input[name='file_upload_web']").val();
            if(file.trim() == ''){
            ...
            $.ajax({
                url:"<?php echo my_url();?>/user/upload_file_web",
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
