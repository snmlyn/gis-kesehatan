<div class="row" id="upload_photo">
    <div class="col-md-12">
        <div class="card mt-20">
            <div class="card-content">
                <h3 class="card-title"> <i class="fa fa-user-circle" aria-hidden="true"></i> UPLOAD PHOTO ANDA</h3>
                <div class="toolbar"></div>
                <div clas="col col-md-3"></div>
                <div clas="col col-md-6">
                    <input type="file" id="file" name="file_upload_photo">
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#upload_photo").on('click', '#upload', function() {
            var file = $("input[name='file_upload_photo']").val();
            if(file.trim() == ''){
            ...
            $.ajax({
                url:"<?php echo my_url();?>admin/upload/photo",
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
